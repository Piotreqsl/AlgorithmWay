...
<Grid container className={classes.form}>
    <Grid item xs></Grid>
        ...
        <Typography variant="h5" className={classes.pageTitle}>Sign up to AlgorithmWay</Typography>


            <Card className={classes.formCard}>
            <form noValidate onSubmit={this.handleSubmit}>

            <TextField variant="outlined" ref={this.nick} color="primary" type="text" id="handle" name="handle" label="Username" className={classes.textField}
            value={this.state.handle} helperText={handleHelper} error={errors.handle ? true : false} onChange={this.handleChange} fullWidth></TextField>
            ...
            value={this.state.password} helperText={errors.password, "Your password should be between 8 and 25 characters long"} error={errors.password ? true : false} onChange={this.handleChange} fullWidth></TextField>

            
            <TextField variant="outlined" type="password" id="confirmPassword" name="confirmPassword" label="Confirm password" className={classes.textField}
            value={this.state.confirmPassword} helperText={errors.confirmPassword} error={errors.confirmPassword ? true : false} onChange={this.handleChange} fullWidth></TextField>
